...
serve(async (req) => {
  ...
  try {
    ...
    const systemInstruction = "You are a helpful, friendly AI assistant. Provide clear, well-structured responses. Use markdown formatting when appropriate for readability.";
